...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup vg = (ViewGroup) inflater.inflate(R.layout.fragment_admin_prof, container, false);

        TextView name = (TextView) vg.findViewById(R.id.textView_name);
        TextView position = (TextView) vg.findViewById(R.id.textView_position);
        TextView username = (TextView) vg.findViewById(R.id.textView_username);
